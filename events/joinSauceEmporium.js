...
async function joinSauceEmporiumEvent(member) {
    ...
    const welcomeMessage = `Ohayo ${member} \nWelcome to Yoni's Sauce Emporium! Please take a second to read the ${member.guild.channels.cache.get(CHANNELS.RULES)} channel before getting lost in the sauce. If you have any further inquires, feel free to ask ${moderator}.`;
